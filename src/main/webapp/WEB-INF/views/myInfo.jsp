			...
			<div class="sig_inner">
				<div class="sig_inputs">
					...
					<div class="sig_input wrap_s">
						...
						<div class="wrap_s">
							<input type="radio" name="chk_info" value="gender"><span
								class="mr20">여자</span> <input type="radio" name="chk_info"
								value="man" checked="checked"><span>남자</span>
						</div>
					</div>
					<div class="sig_input wrap_s">
						<p>
							키/몸무게<span class="red">*</span>
						</p>
